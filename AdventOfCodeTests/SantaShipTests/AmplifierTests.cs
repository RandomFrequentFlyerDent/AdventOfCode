...
namespace AdventOfCodeTests.SantaShipTests
{
    public class AmplifierTests
    {
        ...
        public void AmplifierProgram1()
        {
            ...
            var amplifier = new AmplifierSystem(memory, phaseSequence);
        ...
        [Test]
        public void AmplifierWithFeedbackLooptProgram1()
        {
            var memory = new int[]
            {
            ...
            var phaseSequence = new int[] { 9, 8, 7, 6, 5 };
        ...
        [Test]
        public void AmplifierWithFeedbackLooptProgram2()
        {
            var memory = new int[]
            {
            ...
            var phaseSequence = new int[] { 9, 7, 8, 5, 6 };
